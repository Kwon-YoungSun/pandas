...
# %%
# ----------------------------------------------------------------------------
# get_dumies() 함수를 사용하면, 범주형 변수의 모든 고유값을 각각 새로운 더미 변수로 변환함
# 각 더미 변수가 본래 속해있던 열에는 1이 입력되고, 속하지 않았던 다른 열에는 0이 입력된다.
horespower_dumies = pd.get_dummies(df['hp_bin'])
print(horespower_dumies.head(15))
# %%
